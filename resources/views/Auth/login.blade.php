...
@endpush
@section('content')
    <form method="POST" action="{{url('/login')}}" class="col-sm-8 offset-2">
        
        <div class="wrapping-form">
            <h3>Login Form</h3>
            <div class="form-group">
                <label for="exampleInputEmail1">Email</label>
                <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Masukan Email" aria-describedby="emailHelp">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Password</label>
                <input type="password" name="password" class="form-control" placeholder="Masukan Password" id="exampleInputPassword1">
            </div>
